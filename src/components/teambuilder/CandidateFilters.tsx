      ...
      <div className="filter-row">
        ...
        <div className="threat-inline">
          ...
          <input
            ...
            aria-label="Handles these threats"
            title={`Keeps only sets winning at least ${Math.round(threshold * 100)}% against every opponent listed`}
            value={threatQuery}
            placeholder={filters.threats.length === 0 ? 'Beats these threats…' : 'and…'}
